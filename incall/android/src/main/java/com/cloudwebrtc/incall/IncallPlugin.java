...
import com.cloudwebrtc.incall.AppRTC.AppRTCBluetoothManager;
import com.cloudwebrtc.incall.utils.ConstraintsMap;


/**
 * IncallPlugin
 */
public class IncallPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        channel.setMethodCallHandler(new IncallPlugin(registrar, channel));
    }

    private IncallPlugin(Registrar registrar, MethodChannel channel) {
            ...
            if (tg != null) {
                synchronized (this) {
                    if (!playing) {
                        ...
                        IncallPlugin.this.updateAudioRoute();
